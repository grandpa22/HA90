...
{
    public abstract class Ha90WebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static Ha90WebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(Ha90WebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<Ha90DbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<Ha90DbContext, Task> action)
        {
            using (var context = IocManager.Resolve<Ha90DbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<Ha90DbContext, Task<T>> func)
        {
            T result;
